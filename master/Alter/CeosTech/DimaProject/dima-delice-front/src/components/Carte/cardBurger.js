...
let nomCategorie = "Menu Burger solo"; // à modifier selon la catégorie

const Cardburgersolo = ({
  nom,
  prix,
  id,
  description,
      ...
      <div>
        ...
        >
          ...
          <Modal.Footer className="card__item__total__price">
            <Modal.Body.Heading>
              Prix Total
              <span style={{ fontSize: "5px", color: "black" }}>(TTC)</span>
            </Modal.Body.Heading>
