...
let nomCategorie = "Menu Tacos"; // à modifier selon la catégorie
...
const Cardtacos = ({
  ...
  const [viandeSelected, setViandeSelected] = useState(null);
  ...
  const handleChangeViande_3 = (event) => {
    setViande_3_Selected(event.target.value);
    setError(false);
  };
        ...
        >
          ...
          {nom?.includes("3 viandes") && (
            <>
              ...
              <CardAfficheNombreViande
                viande_nombre={3}
                viande__Selected={viande_3_Selected}
                setViande__Selected={setViande_3_Selected}
                handleChangeViande={handleChangeViande_3}
                choixSupplementViande={choixSupplementViande}
                error={error}
                setError={setError}
                errorUnique={errorUnique}
                  ...
                  return (
                    <div className="sides-radioGroup" key={data.id}>
                      <FormControlLabel
                        ...
                        onClick={() => {
                          //setError(false);
                          setSupplementSelected(sideDish);
                        }}
                      />
                      <Modal.Body.Heading>
