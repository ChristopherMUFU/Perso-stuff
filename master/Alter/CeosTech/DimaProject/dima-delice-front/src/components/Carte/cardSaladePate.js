...
let nomCategorie = "Crêpes sucrées" // à modifier selon la catégorie


const Cardsaladepate = ({
  nom,
  prix,
  id,
  description,
  ...
  const verifySeletedDishes = () => { //Paramètre elements à modifer?
    if (
        ...
        errorSupplement !== true && errorDouble !== true && errorTriple !== true){
