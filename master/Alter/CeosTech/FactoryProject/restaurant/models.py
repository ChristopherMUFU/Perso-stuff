...
class Produit(models.Model):
    ...
    est_sandwich=  models.BooleanField(default=False, null=True)
    est_burger = models.BooleanField(default=False, null=True)
    est_salade = models.BooleanField(default=False, null=True)
    est_texmex = models.BooleanField(default=False, null=True)
    ...
    est_pizza_sauce_special = models.BooleanField(default=False, null=True)
    ...
    taille_pizza = models.CharField(
        choices=taille, max_length=100, blank=True, null=True)
