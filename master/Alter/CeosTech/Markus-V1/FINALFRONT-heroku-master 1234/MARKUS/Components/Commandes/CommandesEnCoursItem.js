...
export default function CommandesEnCoursItem(props) {
            ...
            <View style={styles.headerContainer}>
                                ...
                                return(
                                    <View style={styles.commande}>
                                        <View style={{flexDirection: "row"}}>
                                            ...
                                            <Text style={styles.commandePrix}>{key.produit.prix*key.produit.quantite} €</Text>
                                        </View>
                                    </View>
                                )
                            }
                ...
                </View>
                {
                    !pressed ? null :
                        ...
                        style={styles.button}
                        onPress={() => {
                            props.update(true, props.item.id),
                            props.updateState()
                        }}
                        >
                            <Text style={styles.buttonText}>Remise au client</Text>
                        </TouchableOpacity>
                }
            </View>
        </TouchableOpacity>
