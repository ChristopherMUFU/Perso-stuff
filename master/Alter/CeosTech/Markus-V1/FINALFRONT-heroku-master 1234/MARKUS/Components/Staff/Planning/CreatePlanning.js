...
export default class CreatePlanning extends React.Component {
    ...
    constructor(props){
        ...
        this.state={
            ...
            avantageType: [
                {label:"L'avantage en nature nourriture" , value:"L'avantage en nature nourriture"},
                {label:"L'avantage en nature logement" , value:"L'avantage en nature logement"},
                {label:"L'avantage en nature NTIC" , value:"L'avantage en nature NTIC"},
                {label:"La mise à disposition d'installation sportives" , value:"La mise à disposition d'installation sportives"},
            ],
    ...
    _verifField(){
        ...
        if( isEmpty(this.state.employe) ){
            Alert.alert('Selectionne un Employé ')
            return true
        }

        else if( this.state.qualification == '' ){
            Alert.alert('Selectionne une qualification')
            return true 
        }

        else if( this.state.isAutre && this.state.motif == '' ){
            Alert.alert('Motif non remplis')
            return true 
        }

        else if( this.state.avantage == '' ){
            Alert.alert('Selectionne un aventage')
            return true 
        }

        else if( this.state.comment == '' ){
            Alert.alert('Commentaire non remplis')
            return true 
        }

        else if( !( testHours.test(this.state.startHour) ) || !( testHours.test(this.state.endHour) )  ){
            Alert.alert("Format date incorecte 00h00 ou  la date n'est pas renseigner")
            return true 
        }
    ...
    _createMenue(){
            ...
            return(
                <>
                    <View style={{flexDirection: "row", marginTop: 15 , marginLeft:'7%'}}>
                        <Text style={{color: "#04295D", fontSize: 20}}>Horaires</Text>
                    </View>
                    <View style={{flexDirection: "row", marginTop: '1%' , marginLeft:'7%'}}>
                        <Text style={{color: "#04295D", fontSize: 20 , marginTop:'10%'}}>de</Text>
                        <TextInput 
                            style={{
                                marginTop: 20,
                                margin: "3%",
                        ...
                        <Text style={{color: "#04295D", fontSize: 20 , marginTop:'10%'}}>à</Text>
                    ...
                    <View style={{flexDirection: "row", marginTop: 15 , marginLeft:'7%'}}>
                        <Text style={{color: "#04295D", fontSize: 20}}>Pause</Text>
                    </View>
        ...
        if(this.state.menue == 'absence'){
            return(
                <>
                    <View style={{flexDirection: "row", marginTop: 15 , marginLeft:'7%'}}>
                        <Text style={{color: "#04295D", fontSize: 20}}>Type d'absence</Text>
                    </View>
                    ...
                    <View style={{flexDirection: "row", marginTop: '1%' , marginLeft:'7%'}}>
                        ...
                        <View>
                            ...
                            <View style={{flexDirection: "row", marginTop: 15 , marginLeft:'7%'}}>
                                ...
                                />
                                <Text style={{color: "#04295D", fontSize: 12 , marginTop:'7%'}}>Repos</Text>
                            </View>
                            ...
                            <View style={{flexDirection: "row", marginTop: '5%', marginLeft:'7%'}}>
                                ...
                                />
                                <Text style={{color: "#04295D", fontSize: 12 , marginTop:'7%'}}>Autre</Text>
                            </View>
    ...
    render(){
        ...
        return(
            <ScrollView style={{flex:1, width: windowWidth ,height : '400%'}}>
                ...
                <View style={{width:windowWidth , backgroundColor:"white" , height: '300%' }}>

                        <View style={{flexDirection: "row", marginTop: 15 , justifyContent:'center'}}>
                            <Text style={{color: "#04295D", fontSize: 20}}>{day} {numDay} {month}</Text>
                        </View>
                        ...
                        <View style={{flexDirection: "row", marginTop: 15,justifyContent:'center'}}>
                            ...
                            <TouchableOpacity style={{marginLeft:'15%' , marginTop:'1%'}} onPress={()=> this._changeMenu("shift") } >
                                <Text style={[{color: "#04295D", fontSize: 15 , marginLeft:'15%' , marginTop:'1%'},this.state.isSelectShift]}>Shift</Text>
                            </TouchableOpacity>

                            <TouchableOpacity style={{marginLeft:'15%' , marginTop:'1%'}} onPress={()=> this._changeMenu("absence") } >
                                <Text style={[{color: "#04295D", fontSize: 15, marginLeft:'45%', marginTop:'1%'},this.state.isSelectAbsence]}>Absence</Text>
                            </TouchableOpacity>
                        ...
                        <View style={{flexDirection: "row", marginTop: 15 , marginLeft:'7%'}}>
                            <Text style={{color: "#04295D", fontSize: 20}}>Salarié</Text>
                        </View>
                        ...
                        >
                            ...
                            <DropDownPicker
                                ...
                                dropDownStyle = {{backgroundColor: 'white', borderColor:'#04295D'}}
                                placeholderStyle={{color: '#04295D', fontSize: 16, borderColor:'#04295D'}}
                                labelStyle = {{color:'#04295D', fontSize: 16, borderColor:'#04295D' }}
                                arrowColor = {'#04295D'}
                        ...
                        <View style={{flexDirection: "row", marginTop: 15 , marginLeft:'7%'}}>
                            <Text style={{color: "#04295D", fontSize: 20}}>Avantage</Text>
                        </View>
                        ...
                        >
                            ...
                            <DropDownPicker
                                ...
                                placeholder="Avantage en nature"
                        ...
                        <View style={{flexDirection: "row", marginTop: 15 , justifyContent:'center'}}>
                            <Text style={{color: "#04295D", fontSize: 20}}>Dupliquer le planning</Text>
                        </View>
                        ...
                        <FlatList
                            ...
                            renderItem={({item}) => (
                                ...
                                <View>
                                    <Text style={{marginLeft:'2%' , color:'#04295D',textAlign:'center'}}>{item}</Text>
                                    <CheckBox
                    ...
                    />
                        ...
                        <TouchableOpacity onPress = {() => { this._addPlanning(month,date) }} style={styles.button} >
