...
class InventaireItem extends React.Component {
    ...
    _displayItem(){
        ...
        if(this.state.isVisible){
            ...
            return (
                <LinearGradient 
                    style = {{width: windowWidth, alignItems: 'center', height: windowHeight*0.5, borderWidth : 1.0, borderRadius: 10, borderColor: '#B0B0B0'}} elevation={5} colors={['white' , 'white' , 'white']} 
...
<TouchableOpacity onPress = {() => { this.setState({isVisible : false}), console.log(this.props) }} >
 <FontAwesomeIcon icon={faArrowLeft} style={{color: 'white'}} size={20} />
                ...
                <View style={{width: windowWidth*0.95, alignItems: 'center'}}>
                            ...
                            <TouchableOpacity onPress = {() => this._newQuantite()} style={styles.buttonModifier} >
